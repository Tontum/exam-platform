...
-- 重新创建项目 3
INSERT INTO project (id, name, description, creator_id, status, deleted) VALUES
(3, '2024年度教师年终考核', '年终综合考核，已结束', 1, 2, 0);
...
-- 为项目 3 分配用户
INSERT INTO project_user (id, project_id, user_id, joined_at) VALUES
(100, 3, 3, NOW());

-- 验证结果
SELECT id, name, status, deleted FROM project;
